      <div class="box">
        ...
        <i class="fa fa-lightbulb-o"></i>
          <h3 class="box-title">Data Pendaftaran Praktik Industri</h3>
            <div class="pull-right box-tools">
            <!-- <button type="button" class="btn btn-success btn-sm" data-widget="remove" data-toggle="tooltip" title="Tambah Data"> -->
            <!-- <i class="fa fa-plus"></i></button> -->
            <a href="<?php echo base_url(); ?>guru/add" class="btn btn-success btn-sm" data-toggle="tooltip" title="Tambah Data">&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;</a>
        </div></div>
        <div class="box-body">
      <div class="row">
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="<?php echo base_url()?>guru/edit/<?php echo strEncrypt($value->id); ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Ubah</a>
