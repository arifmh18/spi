...
<!--               <div class="pull-right box-tools">
                <a href="<?php base_url()?>guru/cetak" class="btn btn-info pull-right" data-toggle="tooltip" title="Print Data Guru"><span class="fa fa-print"></span> Print</a>
              </div>
 -->            </div>
            <!-- /.box-header -->
            <!-- form start -->
      ...
      $.ajax({
        ...
        success : function(data) {
          if(data.sts == 1) {
            ...
            setTimeout("location.href='<?php echo base_url() ?>guru'", 2000);
          } else {
