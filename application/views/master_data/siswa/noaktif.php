      <div class="box">
        ...
        <i class="fa fa-lightbulb-o"></i>
          <h3 class="box-title">Data Siswa Belum Aktif</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url()?>siswa/detail/<?php echo strEncrypt($value->id); ?>"><?php echo $value->no_induk ?></a></td>
          ...
          closeOnConfirm: true,
           ...
           $.ajax({
              ...
              success: function(data){
                  ...
                  setTimeout("location.href='<?php echo base_url() ?>siswa/noaktif'", 1500);
  ...
  $(document).on("click",".aktif",function(){
      ...
      swal({
          ...
          closeOnConfirm: true,
           ...
           $.ajax({
              url:"<?php echo base_url()?>siswa/aktif",
              type: "POST",
              data:{id:id},
              success: function(data){
                  swal("Sukses!",data.msg,"success");
