      <div class="row">
        ...
        <div class="col-md-8">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="tambah" class="form-horizontal" action="<?php echo base_url() ?>industri/act_edit/<?php echo strEncrypt($detail[0]->id); ?>" method="post">
              <div class="box-body">
              
                <div class="form-group">
                  <label class="col-sm-3 control-label">NPWP <span style="color: red">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="NPWP" name="induk" value="<?php echo $detail[0]->no_induk; ?>">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url()?>industri" class="btn btn-default pull-right">Kembali</a>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
